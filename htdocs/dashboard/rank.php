...
class Rank{
  ...
  public function createNewRegisterRank($gameID, $score, $class, $end, $depth, $level) {

    $query = "insert into".$this->db_table."(gameID, score, class, end, depth, level) values ('$gameID', '$score', '$class', '$end', '$depth', '$level')";
